...
private:
	...
	sf::Clock reloj;
	sf::Time tiempo, transcurrido, delta;
	...
	bool enjuego;
	int vidasX, vidasY, contadorPersonajes, indice;
	...
	bool arrayPosOcupadas[7] = { false, false, false, false, false,false, false};
	//array de tiempos de personajes en pantalla
	sf::Time arrayTimers[7];
	...
	float arrayTiempos[5] = { 0.5, 1, 1.5, 2, 20 };
	Jugador Jugador1;
	Personaje arrayPersonajes[7];
public:
	WildGunman();
